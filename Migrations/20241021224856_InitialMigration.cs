    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineInventoryLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryLogs_AspNetUsers_AdminUserId",
                        column: x => x.AdminUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryLogs_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryLogs_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryLogs_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryLogs_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MedicineInventoryLogs",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryLogs_DoctorId",
                table: "MedicineInventoryLogs",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryLogs_MedicineId",
                table: "MedicineInventoryLogs",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryLogs_PatientId",
                table: "MedicineInventoryLogs",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryLogs_PrescriptionId",
                table: "MedicineInventoryLogs",
